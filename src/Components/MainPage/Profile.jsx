					...
					<div className='flex-dir-row'>
						<div className='flex-dir-column'>
							...
							<motion.div className='center-horizontal' style={{ paddingTop: "4px" }} whileHover={{ scale: 1.1 }}>
								...
								<a href='https://www.linkedin.com/in/fauzan-farhan-antoro/' target={"_blank"} rel='noreferrer' onMouseEnter={() => hoverSfx.play()} onClick={() => clickSfx.play()}>
									<i className='bi bi-linkedin pad-small'></i>
								</a>
								<a href='https://steamcommunity.com/id/dadangdut33/' target={"_blank"} rel='noreferrer' onMouseEnter={() => hoverSfx.play()} onClick={() => clickSfx.play()}>
									<i className='bi bi-steam pad-small'></i>
								</a>
								<a href='https://ko-fi.com/dadangdut33' target={"_blank"} rel='noreferrer' onMouseEnter={() => hoverSfx.play()}>
