					...
					<div className='flex-dir-row'>
						<div className='flex-dir-column'>
							...
							<div className='center-horizontal' style={{ paddingTop: "4px" }}>
								<a className='tiny-icon' href='https://github.com/Dadangdut33' target={"_blank"} rel='noreferrer' onMouseEnter={() => hoverSfx.play()} onClick={() => clickSfx.play()}>
									<i className='bi bi-github pad-small'></i>
								</a>
								<a className='tiny-icon' href='https://www.linkedin.com/in/fauzan-farhan-antoro/' target={"_blank"} rel='noreferrer' onMouseEnter={() => hoverSfx.play()} onClick={() => clickSfx.play()}>
									<i className='bi bi-linkedin pad-small'></i>
								</a>
								<a className='tiny-icon' href='https://steamcommunity.com/id/dadangdut33/' target={"_blank"} rel='noreferrer' onMouseEnter={() => hoverSfx.play()} onClick={() => clickSfx.play()}>
									<i className='bi bi-steam pad-small'></i>
								</a>
								<a className='tiny-icon' href='https://ko-fi.com/dadangdut33' target={"_blank"} rel='noreferrer' onMouseEnter={() => hoverSfx.play()}>
